...
privileged aspect AMETController_Roo_Controller {
    ...
    public String AMETController.create(@Valid AMET AMET, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        ...
        uiModel.asMap().clear();
        AMET.persist();
        return "redirect:/amets/" + encodeUrlPathSegment(AMET.getId().toString(), httpServletRequest);
    }
    ...
    public String AMETController.show(@PathVariable("id") Long id, Model uiModel) {
        uiModel.addAttribute("amet", AMET.findAMET(id));
    ...
    public String AMETController.updateForm(@PathVariable("id") Long id, Model uiModel) {
        uiModel.addAttribute("AMET", AMET.findAMET(id));
        return "amets/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE)
    public String AMETController.delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        AMET.findAMET(id).remove();
        uiModel.asMap().clear();
